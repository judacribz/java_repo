...
public class lab10 {
	...
	public static void printTree(BTNode<Product> _root)
 	{
 		if(_root != null)
 		{
 			printTree(_root.getLeft());
 			System.out.println(_root.getElement().name);
 			printTree(_root.getRight());
 		}
 	}
}
